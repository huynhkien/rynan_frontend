...
import { CustomerType, Role } from '@/shared/constant/common';
        ...
        {users.map((user, index) => (
          <View style={styles.tableRow} key={user._id}>
            ...
            <View style={styles.tableCol4}>
              <Text style={styles.tableCellLeft}>{Role.find(el => el._id === user.role)?.name || ''}</Text>
            </View>
...
export const DecentralizeManagementFormExport = ({ 
  users, 
}: { 
  users:UserData[]; 
}) => {
