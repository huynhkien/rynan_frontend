...
export const ReceiptExportManagementFormListUser: React.FC<{ user: UserData }> = ({ user }) => {
  ...
  return (
    <>
        ...
        <UserInfoRow label='Tên khách hàng' value={user?.name} />
        ...
        <UserInfoRow label='Địa chỉ xuất hóa đơn' value={user?.invoice_address as string} />
        <UserInfoRow label='CMND' value={user?.identification_card as string} />
        </Box>
    </>
