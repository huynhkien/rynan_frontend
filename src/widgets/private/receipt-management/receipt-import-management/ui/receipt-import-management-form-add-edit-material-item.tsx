...
export const ReceiptImportManagementFormAddEditMaterialItem = ({isEditMaterialState, specifications, materialReceipt, materials, material, handleSelectMaterial}: ReceiptImportManagementFormAddEditMaterialItemProps) => {
    ...
    useEffect(() => {
        if(isEditMaterialState && materialReceipt && specifications) {
            ...
            reset({
                ...
                expiryDate: filteredMaterial?.expiryDate,
                manufacturingDate: filteredMaterial?.manufacturingDate,
            })
        }
