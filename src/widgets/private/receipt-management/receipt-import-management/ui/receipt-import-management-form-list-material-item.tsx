...
export const ReceiptImportManagementFormListMaterialItem = ({materialReceipt, specifications} : ReceiptImportManagementFormListMaterialItemProps) => {
    ...
    <Box sx={{ width: '100%' }}>
                      ...
                      <TableCell>
                        {/* Hành động */}
                            ...
                            <IconButton 
                                ...
                                size='small'
                                onClick={() => handleDelete(item.mid as string)}
                            >
                                <Delete />
                            </IconButton>
                      </TableCell>
      ...
      <Fragment>
        ...
        >
            ...
            <ReceiptImportManagementFormAddEditMaterialItem isEditMaterialState={isEditMaterialState as string} materialReceipt={materialReceipt} specifications={specifications}/>
        </Dialog>
      </Fragment>
    </Box>
  );
