import { Box, Typography, useTheme, TextField, IconButton, Paper, Avatar} from "@mui/material"
import { Send, Person, AttachFile, Circle} from "@mui/icons-material"
import { useState } from "react"
import Image from "next/image";
import { chatbotModel } from "@/features/user/api/userApis";
...
const FormattedContent = ({ content }: {content: string}) => {
  return (
    <ReactMarkdown
      ...
      components={{
        code({ inline, className, children, style}: CodeProps) {
    ...
    const handleSendMessage = async () => {
        if (message.trim()) {
            ...
            try {
                ...
                const response = await chatbotModel(currentMessage);
